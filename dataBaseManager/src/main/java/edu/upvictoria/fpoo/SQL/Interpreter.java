...
public class Interpreter
    ...
    public Void useClause(Clause.UseClause clause) {
        ...
        // write the DTD file for the database
        Writer dtd = new Writer();
        dtd.writeDTD(pathy);
    ...
    public Void createClause(Clause.CreateClause clause) {
        ...
        // add the columns
        // columnsDefinition is a list of lists
        // each list has the column name, the data type and the constraints
